...
- **`rewrite_manifests` last** — manifests track the surviving data files; rewriting them after expiry/orphan-cleanup means you compact a manifest set that already reflects the cleaned table, not one that still references files about to disappear.
